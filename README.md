...
| `--endpoint.headers.allow` | `Connection`, `Cache-Control`, `Upgrade-Insecure-Requests`, `User-Agent`, `Accept`, `Accept-Encoding`, `Accept-Language`, `Cookie` | Allowed HTTP headers to pass to endpoint (canonical form) |
